        ...
        <?php
            ...
            foreach($categories as $category){
                ...
                if($category->parent == 0){
                    ...
                    echo '
                    <a href="'.$web.'/category/'.$category_id.'"><li class="list-group-item d-flex justify-content-between align-items-center">
                        '.$category->name.'
                    ...
                    foreach($categories as $category_child){
                        if($category_child->parent != 0 && $category_parent == $category_child->parent){
                            ...
                            echo '
                            <a href="'.$web.'/category/'.$category_child_id.'"><li class="list-group-item list-group-item-secondary d-flex justify-content-between align-items-center">
                                - '.$category_child->name.'
